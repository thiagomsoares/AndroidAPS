...
class SWDefinition @Inject constructor(
    ...
    private val screenEula
        get() = SWScreen(injector, R.string.terms_of_use_title)
            .skippable(false)
            .add(SWInfoText(injector).label(R.string.terms_of_use_last_update))
            .add(SWInfoText(injector).label(R.string.terms_of_use_info_doubts))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_welcome_text))
            .add(SWInfoText(injector).label(R.string.terms_of_use_objective))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_warning))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_definitions))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_copyright))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_aaps_program))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_modify))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_covered_work))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_propagate))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_transmit))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_aaps_use))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_aaps_use_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_components))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_components_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_requirements_and_equipments))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_requirements_and_equipments_description))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_requirements_and_equipments_1))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_requirements_and_equipments_2))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_requirements_and_equipments_3))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_user_responsability))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_user_responsability_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_user_responsability_caracteristics_1))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_user_responsability_caracteristics_2))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_user_responsability_safaty))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_user_responsability_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_personal_data))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_personal_data_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_warranty_notice))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_warranty_notice_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_limitation_of_liability))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_limitation_of_liability_definition))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_extra_info))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_extra_info_1))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_extra_info_2))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_extra_info_3))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_extra_info_4))
            .add(SWBreak(injector))
            .add(SWInfoText(injector).label(R.string.terms_of_use_i_understand))
            .add(SWBreak(injector))
